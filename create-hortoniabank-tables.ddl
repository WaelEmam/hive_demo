...
DROP TABLE IF EXISTS hortoniabank.us_customers_external;

CREATE EXTERNAL TABLE hortoniabank.us_customers_external(
 number string,
 gender string,
 title string,
 givenname string,
...
STORED AS TEXTFILE
LOCATION '/user/erwin/hortoniabank_data/us_customers'
...
INSERT INTO hortoniabank.us_customers SELECT * FROM hortoniabank.us_customers_external;

------


DROP TABLE IF EXISTS hortoniabank.ww_customers_external;

CREATE EXTERNAL TABLE hortoniabank.ww_customers_external(
  gender string,
  title string,
  givenname string,
  middleinitial string,
...
-- LINES TERMINATED BY '\n' 
STORED AS TEXTFILE
LOCATION '/user/erwin/hortoniabank_data/ww_customers'
tblproperties("skip.header.line.count"="1");


-- ALTER TABLE hortoniabank.ww_customers_external SET SERDEPROPERTIES ('serialization.encoding'='SJIS');
...
gender
  ...
  ,latitude
  ,longitude
FROM hortoniabank.ww_customers_external;

-----

DROP TABLE IF EXISTS hortoniabank.eu_countries_external;

CREATE EXTERNAL TABLE hortoniabank.eu_countries_external(
  countryname string,
  countrycode string,
  region string)
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION '/user/erwin/hortoniabank_data/eu_countries';
...
INSERT INTO hortoniabank.eu_countries SELECT * FROM hortoniabank.eu_countries_external;

-----

use finance;

DROP TABLE IF EXISTS finance.tax_2015_external;

CREATE EXTERNAL TABLE  finance.tax_2015_external(
  ssn string,
  fed_tax double,
  state_tax double,
  local_tax double)
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION '/user/erwin/hortoniabank_data/tax_2015';
...
INSERT INTO finance.tax_2015 SELECT * FROM finance.tax_2015_external;
...
DROP TABLE IF EXISTS cost_savings.claim_savings_external;

CREATE EXTERNAL TABLE cost_savings.claim_savings_external(
`reportdate` date,
`name` string,
`sequenceid` int,
`claimid` int,
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION '/user/erwin/hortoniabank_data/claim_savings';
...
INSERT INTO cost_savings.claim_savings SELECT * FROM cost_savings.claim_savings_external;
...
DROP TABLE IF EXISTS claim.provider_summary_external;

CREATE EXTERNAL TABLE claim.provider_summary_external(
`providerid` string,
`providername` string,
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION '/user/erwin/hortoniabank_data/provider_summary';
...
INSERT INTO claim.provider_summary SELECT * FROM claim.provider_summary_external;
